...
import aagear.items.axes.fivestars.*;
import aagear.items.axes.fourstars.*;
import aagear.items.commands.fourstars.*;
import aagear.items.commands.fivestars.*;
import aagear.items.pickaxes.fivestars.*;
import aagear.items.pickaxes.fourstars.*;
import aagear.items.hoes.fivestars.*;
import aagear.items.hoes.fourstars.*;
import aagear.listeners.axes.*;
import aagear.listeners.commands.CommandInteractListener;
import aagear.listeners.hoes.*;
import aagear.listeners.pickaxes.*;
import aagear.listeners.shovels.*;
...
import static aagear.utility.MessageUtility.message;
...
public class GearHandler extends JavaPlugin {
    ...
    public void onEnable() {
        this.getLogger().info("AAGear v" + VERSION_NUMBER + " - Starting Up");
        ...
        if (cmd.getName().equalsIgnoreCase("gear")) {
            if (args.length == 3) {
                if (args[0].equals("give")) {
                    if (!sender.hasPermission("aagear.give")) {
